...
export function WatermarkCanvas() {
  ...
  useEffect(() => {
    ...
    state.sourceImg, state.activeTab, state.text, state.font, state.size,
    state.style, state.color, state.wmImg, state.wmImgScale, state.position,
    state.opacity, state.rotation, state.margin, state.freeX, state.freeY,
    getRenderOpts,
  ]);
