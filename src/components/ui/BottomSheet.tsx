...
export function BottomSheet({ isOpen, onClose, title, children }: BottomSheetProps) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className={`fixed inset-0 bg-black/60 z-[100] transition-opacity duration-300 min-[900px]:hidden
      ...
      >
        ...
        {/* Content */}
        <div className="p-5 overflow-y-auto overscroll-contain flex flex-col gap-4">
          {children}
        </div>
      </div>
    </>
