...
export function PositionStyleCard() {
  ...
  return (
    <>
      <p className="text-[0.65rem] font-bold tracking-[0.1em] uppercase text-[var(--text-muted)] mb-3">{t('position.label')}</p>

      <label htmlFor="wm-position" className="!mt-0">{t('position.positionLabel')}</label>
