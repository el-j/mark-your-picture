  ...
  return (
    <main className="mx-auto flex w-full max-w-[680px] flex-col gap-4 px-5 py-8">
      ...
      <div className={cardCls}>
        <h3 className="mb-1.5 font-bold text-[0.95rem] text-[var(--text)]">
          {t('about.why.heading')}
        </h3>
      ...
      <div className={cardCls}>
        ...
        <a
          ...
          className="mt-3 inline-flex items-center gap-1.5 rounded-[var(--radius-sm)] bg-[var(--accent)] px-4 py-2.5 font-semibold text-[0.82rem] text-white no-underline shadow-[0_2px_8px_var(--accent-glow)] transition-all hover:-translate-y-px hover:bg-[var(--accent-hover)]"
        >
      ...
      <div className={`${cardCls} flex items-center justify-between`}>
        <span className="font-medium text-[0.78rem] text-[var(--text-muted)]">
          {t('about.version')}
        </span>
        <span className="font-mono font-semibold text-[0.78rem] text-[var(--accent)]">
          v{__APP_VERSION__}
        </span>
      </div>
    </main>
