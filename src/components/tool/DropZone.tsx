...
export function DropZone() {
  ...
  return (
    ...
    >
      <svg className="opacity-45 mb-2.5 mx-auto" role="img" aria-label="Upload image" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
